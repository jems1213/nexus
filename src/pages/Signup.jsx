...
const Signup = () => {
  ...
  const handleGoogleError = () => {
    setErrorMessage('Google login failed. Please try again or use email signup.');
  ...
  const Notification = ({ open, severity, message, onClose }) => {
    const icon = severity === 'success' ? 
      <CheckCircleOutline sx={{ fontSize: '24px' }} /> : 
                          ...
                          InputProps={{
                            startAdornment: (
                              <InputAdornment position="start">
                                <motion.div
                                  animate={{ 
                                    color: isFocused.name ? theme.palette.primary.main : 'action'
                                  }}
                                >
                                  <PersonIcon />
                                </motion.div>
